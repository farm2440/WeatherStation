// ======================================================================
// WeatherStation.v generated from TopDesign.cysch
// 10/13/2020 at 21:27
...
module ADC_SAR_SEQ_P4_v2_40_3 (
	...
	cy_psoc3_pins_v1_10
		#(.id("e1c062be-19b1-4181-8fe6-1dbaf771697b/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("e1c062be-19b1-4181-8fe6-1dbaf771697b/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
...
module top ;
	...
	wire [0:0] tmpOE__HUM_net;
	wire [0:0] tmpFB_0__HUM_net;
	wire [0:0] tmpIO_0__HUM_net;
	wire [0:0] tmpINTERRUPT_0__HUM_net;
	electrical [0:0] tmpSIOVREF__HUM_net;
	...
	cy_psoc3_pins_v1_10
		...
		HUM
		 (.oe(tmpOE__HUM_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HUM_net[0:0]}),
		  .io({tmpIO_0__HUM_net[0:0]}),
		  .siovref(tmpSIOVREF__HUM_net),
		  .interrupt({tmpINTERRUPT_0__HUM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HUM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_1 Timeout (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	cy_clock_v1_0
		#(.id("a87b6101-07ee-4b99-be3a-068515d6b403"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8a0aecc6-e2c9-4cff-ba04-e6f6ed8d496a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("a1eb13a1-7201-4d0d-9e4c-5b24f39894df"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__PinWindCE_net;
	wire [0:0] tmpFB_0__PinWindCE_net;
	wire [0:0] tmpIO_0__PinWindCE_net;
	wire [0:0] tmpINTERRUPT_0__PinWindCE_net;
	electrical [0:0] tmpSIOVREF__PinWindCE_net;

	cy_psoc3_pins_v1_10
		#(.id("d8cd98a1-9e62-464a-a402-1469ebc9e108"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		PinWindCE
		 (.oe(tmpOE__PinWindCE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PinWindCE_net[0:0]}),
		  .io({tmpIO_0__PinWindCE_net[0:0]}),
		  .siovref(tmpSIOVREF__PinWindCE_net),
		  .interrupt({tmpINTERRUPT_0__PinWindCE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PinWindCE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PinWindRX_net;
	wire [0:0] tmpFB_0__PinWindRX_net;
	wire [0:0] tmpIO_0__PinWindRX_net;
	wire [0:0] tmpINTERRUPT_0__PinWindRX_net;
	electrical [0:0] tmpSIOVREF__PinWindRX_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		PinWindRX
		 (.oe(tmpOE__PinWindRX_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PinWindRX_net[0:0]}),
		  .io({tmpIO_0__PinWindRX_net[0:0]}),
		  .siovref(tmpSIOVREF__PinWindRX_net),
		  .interrupt({tmpINTERRUPT_0__PinWindRX_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PinWindRX_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_Ubat_net;
	wire [0:0] tmpFB_0__Pin_Ubat_net;
	wire [0:0] tmpIO_0__Pin_Ubat_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Ubat_net;
	electrical [0:0] tmpSIOVREF__Pin_Ubat_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Ubat
		 (.oe(tmpOE__Pin_Ubat_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Ubat_net[0:0]}),
		  .analog({Net_345}),
		  .io({tmpIO_0__Pin_Ubat_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Ubat_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Ubat_net[0:0]}),
		  .annotation({Net_804}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_Ubat_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Rain_net;
	wire [0:0] tmpIO_0__Pin_Rain_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Rain_net;
	electrical [0:0] tmpSIOVREF__Pin_Rain_net;

	cy_psoc3_pins_v1_10
		#(.id("ab74ea44-d1ef-4f79-87dc-b8ef44ac37b6"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Rain
		 (.oe(tmpOE__Pin_Rain_net),
		  .y({1'b0}),
		  .fb({Net_290}),
		  .io({tmpIO_0__Pin_Rain_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Rain_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Rain_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Rain_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    Debouncer_v1_0 Debouncer_Rain (
        .d(Net_290),
        .clock(Net_291),
        .q(Net_524),
        .neg(Net_522),
        .either(Net_671),
        .pos(Net_523));
    defparam Debouncer_Rain.EitherEdgeDetect = 1;
    defparam Debouncer_Rain.NegEdgeDetect = 1;
    defparam Debouncer_Rain.PosEdgeDetect = 1;
    defparam Debouncer_Rain.SignalWidth = 1;


	cy_clock_v1_0
		#(.id("d4daf5b1-b765-43f0-bea8-6e7f6c55129a"),
		  .source_clock_id(""),
		  .divisor(0),
